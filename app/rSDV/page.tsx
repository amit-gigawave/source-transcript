...
import { rsdvFeatures } from "@/lib/content";
...
// Icon mapping from Bootstrap icons to Lucide icons for rSDV
const iconMap: Record<string, any> = {
  ...
  "bi bi-folder": Folder,
  "bi bi-people": Users,
  "bi bi-file-earmark-pdf": FileType,
  "bi bi-pen": PenTool,
  "bi bi-clipboard-data": ClipboardList,
  "bi bi-shield": Shield,
  "bi bi-lock": Lock,
  "bi bi-pc-display-horizontal": Monitor,
  "bi bi-filetype-pdf": FileType,
  "bi bi-chevron-left bi bi-chevron-right": Code,
  "bi bi-signature": Signature,
  "bi bi-layers": Layers,
};
...
const RSDVPage = () => {
  return (
    <PageLayout backgroundVariant="gradient" minHeight="screen">
      {/* Hero Section */}
      <Hero
        badge="rSDV (Remote Source Data Verification)"
        title="Transform CRA Monitoring with Digital Oversight"
        subtitle={rsdvFeatures.title}
        description={rsdvFeatures.description}
      ...
      <AnimatedBg />
      {/* Features Sections */}
      {rsdvFeatures.child.map((section, sectionIndex) => (
        <Section
          key={sectionIndex}
      ...
      {/* <Section backgroundVariant="gradient" padding="xl" maxWidth="4xl">
        ...
        >
          <h2 className="text-4xl sm:text-5xl font-bold text-foreground mb-6 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
            Ready to Revolutionize Clinical Monitoring?
          </h2>
          <p className="text-xl text-muted-foreground mb-12 leading-relaxed">
            Join leading pharmaceutical companies who trust our rSDV system to
            streamline remote source data verification and enhance clinical
            research monitoring efficiency.
          </p>
          <motion.div
