...
import { iwrsFeatures } from "@/lib/content";
...
// Icon mapping from Bootstrap icons to Lucide icons for IWRS
const iconMap: Record<string, any> = {
  ...
  "bi bi-shuffle": Shuffle,
  "bi bi-box": Package,
  "bi bi-people": Users,
  "bi bi-clock": Clock,
  "bi bi-bar-chart": BarChart3,
  "bi bi-layers": Layers,
};
...
const IWRSPage = () => {
  return (
    <PageLayout backgroundVariant="gradient" minHeight="screen">
      {/* Hero Section */}
      <Hero
        badge="Interactive Web Response System"
        title="IWRS System"
        subtitle={iwrsFeatures.title}
        description={iwrsFeatures.description}
      ...
      <AnimatedBg2 />
      {/* Features Sections */}
      {iwrsFeatures.child.map((section, sectionIndex) => (
        <Section
          key={sectionIndex}
      ...
      {/* <Section backgroundVariant="gradient" padding="xl" maxWidth="4xl">
        ...
        >
          <h2 className="text-4xl sm:text-5xl font-bold text-foreground mb-6 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
            Ready to Optimize Your Randomization Process?
          </h2>
          <p className="text-xl text-muted-foreground mb-12 leading-relaxed">
            Join leading pharmaceutical companies who trust our IWRS system to
            streamline randomization, supply management, and patient enrollment
